...
function BASS_Encode_ServerInit(handle:HENCODE; port:PAnsiChar; buffer,burst,flags:DWORD; proc:ENCODECLIENTPROC; user:Pointer): BOOL; stdcall; external bassencdll;
function BASS_Encode_ServerKick(handle:HENCODE; client:PAnsiChar): BOOL; stdcall; external bassencdll;
