...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libvpee.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libvpee.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared

${OBJECTDIR}/_ext/1472/vinPlayer_etern_extrnsion.o: ../vinPlayer_etern_extrnsion.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/vinPlayer_etern_extrnsion.o ../vinPlayer_etern_extrnsion.cpp
